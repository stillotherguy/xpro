...
public class ClientStatistics {
    ...
    public ClientStatistics(List<Statistics> statisticsList) throws InterruptedException {
        this.statisticsList = statisticsList;
        statisticTime = statisticsList.get(0).statisticTime;
    }
    ...
    public void collectStatistics() throws InterruptedException {
        ...
        for(int i=0; i < statisticsList.get(0).statisticTime;i++) {
            long runnableTPS = 0;
            for (Statistics statistic : statisticsList) {
